        ...
        <tbody>
          {questions.map((question) => (
            <tr key={question.Id}>
              ...
              <td>{question.subject_grade.subject.Name ? question.subject_grade.subject.Name : 'Unknown'}</td>
              <td>{question.subject_grade.grade.Name ? question.subject_grade.grade.Name : 'Unknown'}</td>
              <td>
