...
function QuestionsPage() {
  ...
  const handleEditClick = (question) => {
    ...
    setFormData({
      ...
      SubjectId: question.SubjectGradeId, // Assuming this is the correct mapping
    ...
    <Container>
      <Row>
        <Col md={12}>
          ...
          <Button variant="primary" onClick={() => setShowModal(true)} className='text-center'>Add New Question</Button>
          {questions.map(q => (
