        ...
        <tbody>
          {questions.map((question) => (
            <tr key={question.Id}>
              ...
              <td>{question.subject_grade.subject ? question.subject_grade.subject.Name : 'Unknown'}</td>
              <td>{question.subject_grade.grade ? question.subject_grade.grade.Name : 'Unknown'}</td>
              <td>
                <Button variant="link" onClick={() => handleEdit(question)}><FaEdit className='text-warning'/></Button>
                <Button variant="link" onClick={() => handleShowConfirmDelete(question.Id)}><FaTrash className='text-danger'/></Button>
              </td>
            </tr>
          ))}
        </tbody>
