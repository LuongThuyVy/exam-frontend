        ...
        <tbody>
          {examShifts.map((shift) => (
            <tr key={shift.id}>
              ...
              <td>
                {shift.subject_grade ? `${shift.subject_grade.Name} - ${shift.subject_grade.Description}` : 'Unknown'}
              </td>
              <td>
                {shift.subjectgrade && shift.subjectgrade.subject ? shift.subjectgrade.subject.Name : 'N/A'}
              </td>
              <td>
                {shift.subjectgrade && shift.subjectgrade.grade ? shift.subjectgrade.grade.Name : 'N/A'}
              </td>
              <td>
                <Button variant="warning" onClick={() => handleEdit(shift)}><FaEdit /></Button>
                <Button variant="danger" onClick={() => handleDelete(shift.id)}><FaTrash /></Button>
              </td>
            </tr>
          ))}
        </tbody>
