                                    ...
                                    <div className='col-md-6 mb-4' key={answer.Id}>
                                        <div className='card'>
                                            <div className='card-body'>
                                                ...
                                                <p className={`card-text ${!isCorrect ? 'text-danger' : 'teẽ'}`}><strong>Your Answer:</strong> {answer.SelectedOption}. {getOptionContent(answer.question_answer, answer.SelectedOption)}</p>
                                                {!isCorrect && (
