...
const TestPage = () => {
  ...
  const handleConfirmStart = () => {
    if (selectedExamShift) {
      // Store examId and duration in local storage
      localStorage.setItem('examId', selectedExamShift.examShift.id);
      localStorage.setItem('duration', selectedExamShift.examShift.subjectgrade ? selectedExamShift.examShift.subjectgrade.Duration : 'Unknown Duration');
