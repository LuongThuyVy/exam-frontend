    ...
    return (
        <div>
                    ...
                    <div className='score-circle-container'>
                        <svg className='score-circle' width='100' height='100' viewBox='0 0 100 100'>
                            ...
                            <circle
                                ...
                                strokeDashoffset='70'
                            />
                            <text className='score-text' x='50%' y='50%' textAnchor='middle' dy='.3em'>
                            {test.Score !== null ? test.Score : 'N/A'}</span>
                            </text>
                        </svg>
                    </div>
                </div>
            ...
            <div className='d-flex justify-content-center mb-4'>
                <p className='me-3'><strong>Correct Answers:</strong> {correctAnswersCount}</p>
