                        ...
                        <ul>
                            {test.answers.map((answer, index) => (
                                <li key={answer.Id}>
                                    ...
                                    <p><strong>Your Answer:</strong> {answer.SelectedOption}. {getSelectedOption(answer.question_answer, answer.question_answer.SelectedOption)}</p>
                    ...
                    {test.answers && test.answers.length > 0 ? (
                        <ul>
                            {test.answers.map((answer, index) => (
                                <li key={answer.Id}>
                                    <p><strong>Question {index + 1}:</strong> {answer.question_answer.Content}</p>
                                    <p><strong>Your Answer:</strong> {answer.SelectedOption}. {getSelectedOption(answer.question_answer, answer.SelectedOption)}</p>
                                    <p><strong>Correct Answer:</strong> {answer.question_answer.CorrectOption}. {getOptionContent(answer.question_answer, answer.question_answer.CorrectOption)}</p>
                                </li>
                            ))}
                        </ul>
...
// Helper function to get the content of the selected option
const getSelectedOption = (question, selectedOption) => {
