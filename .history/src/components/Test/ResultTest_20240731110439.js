                                ...
                                <div className='col-md-6 mb-4' key={answer.Id}>
                                    <div className='card'>
                                        <div className='card-body'>
                                            ...
                                            <p className='card-text text-success'><b></b>Correct Answer: {answer.question_answer.CorrectOption}. {getOptionContent(answer.question_answer, answer.question_answer.CorrectOption)}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
