...
const TestDetails = () => {
    ...
    return (
        <div>
            ...
            <p><strong>Completion Time:</strong> {test.CompletionTime !== null ? test.CompletionTime : 'N/A'}</p>
            <p><strong>Exam Shift Name:</strong> {test.exam_shift ? test.exam_shift.Name : 'N/A'}</p>
            <p><strong>Start Time:</strong> {test.exam_shift ? new Date(test.exam_shift.StartTime).toLocaleString() : 'N/A'}</p>
            <p><strong>End Time:</strong> {test.exam_shift ? new Date(test.exam_shift.EndTime).toLocaleString() : 'N/A'}</p>
        </div>
    );
};
