...
const Test = () => {
  ...
  return (
    <Container className="mt-4">
      ...
      {/* Success Modal */}
      <Modal show={showSuccessModal} onHide={() => navigate(`/test/${localStorage.getItem('testId')}`)}>
        <Modal.Header closeButton>
          <Modal.Title>Submission Successful</Modal.Title>
        </Modal.Header>
        <Modal.Body>Your answers have been submitted successfully!</Modal.Body>
        <Modal.Footer>
          <Button variant="primary" onClick={() => navigate(`/test/${localStorage.getItem('testId')}`)}>
            OK
          </Button>
        </Modal.Footer>
      </Modal>
