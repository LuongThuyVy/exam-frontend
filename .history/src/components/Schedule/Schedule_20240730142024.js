    ...
    <Container className="mt-4">
      ...
      <Row>
        {examShifts.map(shift => {
          ...
          const isExpired = new Date(shift.examShift.endTime).getTime() < new Date().getTime();
          const isNotYetAvailable = new Date(shift.examShift.startTime).getTime() > new Date().getTime();
                  ...
                  <Row>
                    ...
                    <Col>
                      <Button
                        ...
                        className="w-100"
                        disabled={isExpired || isNotYetAvailable}
                      >
                        Start Test
                      </Button>
                    </Col>
