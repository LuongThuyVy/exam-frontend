      ...
      <Form onSubmit={handleSubmit}>
        {step === 1 && (
          <>
            ...
            <Button variant="primary" onClick={nextStep} className="mt-3 btn-outline-primary button">Next</Button>
        ...
        {step === 2 && (
          <>
            ...
            <Button variant="secondary" onClick={prevStep} className="mt-3 btn-outline-primary button">Back</Button>
