...
function Register() {
  ...
  const validateStep2 = () => {
    const { email, password, policyAccepted } = formData;
    let valid = true;
    let newErrors = {};
    ...
    if (!policyAccepted) {
      newErrors.policyAccepted = "Bạn cần đồng ý với các điều khoản trước khi tiếp tục";
      valid = false;
    }
    setErrors(newErrors);
    return valid;
  ...
  const nextStep = () => {
    if (step === 1 && validateStep1()) {
      ...
      // Trigger form submission if all validations pass
      handleSubmit();
    }
  };
  ...
  return (
    <Container className="mt-4 col-sm-6 offset-sm-3 mb-5">
          ...
          <>
            ...
            <Form.Group controlId="formPolicyAccepted" className="mt-3">
              <Form.Check
                ...
                label={
                  <span>
                    Tôi đã đọc <a href="#" onClick={handleShowModal}>các điều khoản và điều kiện</a>
                  </span>
                }
            ...
            <Button variant="primary" onClick={nextStep} className="mt-3 button">Register</Button>
          </>
        )}
      </Form>
      ...
      <Modal show={showModal} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          <p>Here you can include the content of your terms and conditions.</p>
        </Modal.Body>
        <Modal.Footer>
