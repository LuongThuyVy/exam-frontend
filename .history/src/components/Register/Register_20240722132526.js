      ...
      <Form onSubmit={handleSubmit}>
        {step === 1 && (
          <>
            ...
            <Button variant="primary out-line" onClick={nextStep} className="mt-3 button">Next</Button>
        ...
        {step === 2 && (
          <>
            ...
            <Button variant="out-line secondary" onClick={prevStep} className="mt-3 button">Back</Button>
