...
function Home() {
  return (
        <>
          <div className="hero" style={{ width: '100%', height: '33.33vh', backgroundImage: 'url(/hero.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
          <Container fluid>
            <Row className="my-5 text-center">
              <Col>
                <p>Lorem ipsum dolor sit amet, consectetur...</p>
                <Button variant="primary">Đăng ký thi ngay!</Button>
              </Col>
            </Row>
