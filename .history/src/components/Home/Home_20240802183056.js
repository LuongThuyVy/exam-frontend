...
function Home() {
  return (
    <>
      ...
      <Container fluid>
      <h1 className='text-center'>Welcome to <b>Example</b></h1>
          <p className='text-center'>Make Your Exam Simple!</p>
         <div className='text-center'> <Link to="/shift" className="btn btn-primary">Get Started</Link></div>
