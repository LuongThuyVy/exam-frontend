        ...
        <Row className="my-2">
          <Col lg={4} md={6} className="mb-2 mb-md-0">
            ...
            <div className="text-center text-dark">
              <b><p className="text-uppercase" >Example</p></b>
          ...
          <Col lg={4} md={6} className="mb-2 mb-md-0">
            ...
            <ListGroup variant="flush">
              <ListGroup.Item className="text-decoration-none text-black">
                <Link to="/contact">
              ...
              <Link to="/contact">
                  <FaGraduationCap className="pe-2" />ChinhsCh
                </Link>
              </ListGroup.Item>
              <ListGroup.Item className="text-dark">
                <a target="_blank" rel="noopener noreferrer" href="#" className="text-decoration-none text-black bg-transparent">
