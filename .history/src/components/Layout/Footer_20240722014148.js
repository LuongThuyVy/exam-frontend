        ...
        <Row className="my-2">
          ...
          <Col lg={4} md={6} className="mb-2 mb-md-0">
            ...
            <ListGroup variant="flush" className="text-dark">
              <ListGroup.Item>
                <FaMapMarkerAlt className="pe-2 bg-transparent" />97 Man Thien, Hiep Phu, District 9, HCMC
              </ListGroup.Item>
              <ListGroup.Item>
                <FaPhone className="pe-2 bg-transparent" />+84 70 666 2826
              </ListGroup.Item>
              <ListGroup.Item>
                <FaEnvelope className="pe-2 mb-0 bg-transparent" />n20dccn085@example.com
              </ListGroup.Item>
            </ListGroup>
          </Col>
        </Row>
