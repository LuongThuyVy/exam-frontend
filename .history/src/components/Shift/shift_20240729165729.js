  ...
  return (
    <Container className="mt-4">
      ...
      <Modal show={showSuccessModal} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          <p className="text-success">Congratulations, you have successfully signed up. Please go to the exam schedule page to view your exam schedule.</p>
        </Modal.Body>
        <Modal.Footer>
          <Button variant="primary" onClick={() => window.location.href = 'http://localhost:3000/schedule'}>
            Go to Schedule
          </Button>
        </Modal.Footer>
      </Modal>
